...
class SimulationSynchronization(object):
    ...
    def __init__(self,
        ...
        self.odometers_cum = []
        self.i_v = 0
        self.color_box = [(0,0,0),(255,255,255),(255,0,0),(0,255,0),(0,0,255),(255,255,0),(0,255,255),(255,0,255),\
    ...
    def tick(self):
        ...
        for sumo_actor_id in self.sumo2carla_ids:
            ...
            # Once the vehicles enter the area less than 60m away from the center, the dynamic control (throttle & steering) starts.
            ...
            # If the vehicle is more than 60m away from the center, there is no dynamic control, 
            # and the position of the vehicle is simply updated by coordinate transform
        ...
        # Dealing with the vehicles which already left the intersection in SUMO but are still stuck in Carla due to collision.
...
def synchronization_loop(args):
    ...
    sumo_simulation = SumoSimulation(args.sumo_cfg_file, args.step_length, args.sumo_host,
                                     args.sumo_port, args.sumo_gui, args.client_order, pretrained=args.pretrained_weights)
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--pretrained-weights',
                           type=str,
                           help="path to your pretrained GNN weights (default: '')",
                           default='')
